...
public class ViewRequestStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = sh.getString("url", "")+"and_view_request_status";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                paymentdate=new String[js.length()];
                                paymentstatus=new String[js.length()];
...
//                                rating=new String[js1.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    paymentdate[i]=u.getString("payment_date");
                                    paymentstatus[i]=u.getString("payment_status");
...
//                                }
                                ...
                                li.setAdapter(new CustomRequestStatus(getApplicationContext(),date,status,paymentdate,paymentstatus,amount));
