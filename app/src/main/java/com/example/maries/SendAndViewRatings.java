...
public class SendAndViewRatings extends AppCompatActivity {
    ListView li;
    String[] date,rate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_and_view_ratings);
...
//                                }
                                ...
                                li.setAdapter(new CustomView(getApplicationContext(),date,rate));
