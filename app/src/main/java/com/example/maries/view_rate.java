...
public class view_rate extends AppCompatActivity {
    ListView li;
...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                li.setAdapter(new custom_view_rate(getApplicationContext(), rid,rate,date,userinfo));//custom_view_service.xml and li is the listview object
