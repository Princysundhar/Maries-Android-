...
public class ViewService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url=sh.getString("url","")+"and_feed_back";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                descrption=new String[js.length()];
...
//
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    id[i]=u.getString("id");
                                    descrption[i]=u.getString("descrption");
...
//                                }
                                ...
                                li.setAdapter(new CustomService(getApplicationContext(),id,descrption,price,photo));
