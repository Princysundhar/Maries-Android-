...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1 = findViewById(R.id.button2);                        // Login
...
//                    Toast.makeText(login.this, "Enter password with relevent matches", Toast.LENGTH_SHORT).show();
//                    flag++;
//                }
                if(flag==0) {
...
//                                Toast.makeText(Login.this, "welcome to maries", Toast.LENGTH_SHORT).show();
