...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                li.setAdapter(new custom_view_service(getApplicationContext(),sid,photo,description,price));//custom_view_service.xml and li is the listview object
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("sub_id", sh.getString("sub_id", ""));//passing to python
